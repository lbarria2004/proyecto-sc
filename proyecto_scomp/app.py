...
from services.calculations import process_data_vejez, process_data_sobrevivencia, get_sort_key_vejez, get_sort_key_sobrevivencia
...
if uploaded_file is not None:
    ...
    if raw_data:
        ...
        if "SOBREVIVENCIA" in tipo_pension:
            ...
            c1, c2 = st.columns(2)
            c1.download_button("📄 Descargar PDF Pro", pdf_bytes, "Reporte_Sobrevivencia.pdf", "application/pdf", use_container_width=True)
            c2.download_button("📊 Descargar Excel", excel_bytes, "Reporte_Sobrevivencia.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", use_container_width=True)
        ...
        # === VEJEZ / INVALIDEZ ===
            ...
            c1, c2 = st.columns(2)
            c1.download_button("📄 Descargar PDF Pro", pdf_bytes, "Reporte_Previsional.pdf", "application/pdf", use_container_width=True)
            c2.download_button("📊 Descargar Excel", excel_bytes, "Reporte_Previsional.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", use_container_width=True)
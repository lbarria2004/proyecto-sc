...
def process_data_vejez(raw_data, header_data, include_pgu=True, pgu_amount=0, include_bono=True, bono_uf=0):
    ...
    for item in tables_data:
        ...
        if item['tipo'] == 'RT_RVD':
            ...
            df_base[col_title_pdf] = (df_base["Pension_Liquida"] + valor_pgu + valor_bono).round(0)
            ...
            df_temporal[col_title_pdf] = (df_temporal["Pension_Liquida"] + valor_pgu + valor_bono).round(0)
            ...
            df_aumentada[col_title_pdf] = (df_aumentada["Pension_Liquida"] + valor_pgu + valor_bono).round(0)
            ...
            df[col_title_pdf] = (df["Pension_Liquida"] + valor_pgu + valor_bono).round(0)
